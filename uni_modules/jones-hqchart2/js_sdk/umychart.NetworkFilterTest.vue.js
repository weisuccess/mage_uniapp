...
var ChartData=HQChart.ChartData;
// #endif
	
// #ifndef H5
import {JSCommon} from './umychart.wechat.3.0.js'
var ChartData=JSCommon.ChartData;
// #endif
...
HQData.NetworkFilter=function(data, callback)
{
    ...
    switch(data.Name) 
    {
		...
		case 'JSSymbolData::GetSymbolData':								//指标计算需要的K线数据
...
HQData.Minute_RequestPopMinuteData=function(data, callback)
{
	...
	var hqchartData=JSON.parse(JSON.stringify(MINUTE_1DAY_DATA));
	var stock=hqchartData.stock[0];
	stock.IsHistoryMinute=true;
	for(var i=0;i<stock.minute.length;++i)
	{
		var minItem=stock.minute[i];
		minItem.date=date;
	}
