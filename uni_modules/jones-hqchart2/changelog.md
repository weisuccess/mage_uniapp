## 1.1.15324（2025-11-03）
15323 小程序MinuteTimeStringData::GetTimeData(symbol, option)增加第2个可选参数  
15322 小程序修正ChartMinutePriceLine增加只有1个数据时不显示  
## 1.1.15321（2025-10-29）
15320 ChartMultiBar增加 AdWidth属性  
## 1.1.15310（2025-10-20）
15308 小程序ChartPointDot支持上涨下跌颜色配置  
15307 ChartPointDot支持上涨下跌颜色配置  
## 1.1.15306（2025-10-15）
15305 分钟K线增加流通股本字段对接  
15302 小程序DRAWNUMBER_FIX支持后台对接  
15300 ChartDrawText_Fix支持&换行  
## 1.1.15299（2025-10-12）
15296 小程序后台指标支持DRAWTEXT_FIX  
15295 后台指标支持DRAWTEXT_FIX  
15294 右键菜单增加Y轴拖动选项  
15293 获取国内期货交易时间段接口增加option参数  
## 1.1.15292（2025-10-10）
15290 小程序DRAWLINE算法修改  
15288 DRAWLINE支持虚线DOTLINE  
15287 修正DRAWLINE右侧延长线算法  
15285 小程序修正DynamicChartTitlePainting::FormatValue()格式错误  
15284 小程序分时图支持LatestPointFlashPaint  
15283 小程序KLineTooltipPaint，MinuteTooltipPaint数值支持左对齐  
15282 KLineTooltipPaint::DrawTooltipData()数值左对齐时， 默认跟标题间距4个像素  
15281 LatestPointFlashPaint支持一直显示  
15280 KLineTooltipPaint,MinuteTooltipPaint支持数值左对齐  
15279 小程序修正DRAWNUMBER()在单值时没有处理小数位数  
15277 修正函数DRAWNUMBER_Temp_NumberItem()在单值时没有处理小数位数  
15274 增加CSSFONT函数  
## 1.1.15273（2025-10-06）
15272 小程序重构叠加指标DRAWNUMBER_FIX，DRAWTEXT_FIX  
15269 小程序重构DRAWTEXT_FIX,DRAWNUMBER_FIX  
15268 DRAWNUMBER_FIX绘图代码重构  
15267 叠加指标使用ChartDrawText_Fix  
15266 DRAWTEXT_FIX代码重构  
15264 小程序修改函数FILTERX算法  
15262 修改FILTERX，DRAWTEXT算法  
15261 增加绘图最后时间状态DrawStatusData  
## 1.1.15258（2025-09-26）
5257 小程序JSExplainer增加MAX6，MIN6  
15256 JSExplainer增加MAX6, MIN6  
## 1.1.15255（2025-09-25）
15250 修正 ScriptIndex.IsShortTitle变量赋值类型判断错误
## 1.1.15237（2025-09-18）
15236 修正画图工具横线拖动有时候定位错误  
15234 修正ChartMinuteVolumBar没有判断数据有效性  
15232 ChartDrawHLine 右侧文字使用底部对齐  
## 1.1.15199（2025-09-10）
15197 调整修改画图工具按钮间距  
15196 JSDialogModifyDraw增加颜色选择器  
15194 JSDialogDrawTool增加选色器  
15193 ReloadChartDrawPicture()把事件回调移到外层  
15192 MinuteChartContainer::ReloadChartDrawPicture()增加事件ON_LOAD_DRAWPICTURE  
15189 ShowModifyIndexParamDialog()增加判断指标名称都空的情况  
15188 JSDivFrameToolbar使用css主题切换  
## 1.1.15147（2025-08-26）
15146 指标参数修改对话框主题使用css  
15145 指标搜索框主体使用css  
15143 JSDialogModifyDraw使用css切换风格  
15140 画图工具使用css切换主题  
15137 AverageWidthFrame::ReloadResource()工具条类型改变清空div工具条  
15135 修正CalculateLock() 没有判断LockPaint是否有效  
## 1.1.15134（2025-08-22）
15133 SetSubFrameOption增加更新div工具条  
15132 SetSubFrameAttribute增加div工具栏更新  
15130 小程序指标标题支持多行或单行输出  
## 1.1.15121（2025-08-20）
15119 增加指标异常提示信息  
15118 DrawNotSupportmessage支持横屏  
15117 小程序DrawNotSupportmessage支持横屏  
15115 h5指标重构代码同步到移植到小程序  
15114 函数TryClickLock移动到JSChartContainer  
15113 增加DOM类注册  
15112 指标锁增加最小宽度  
15110 重构指标锁， 支持叠加指标上锁  
15109 修正CalculateLock()没有计算区域  
15107 小程序ChartLock支持image  
15105 ChartLock支持图片  
## 1.1.15104（2025-08-18）
15102 小程序增加十字光标状态变动事件  
15100 增加十字光标状态变动事件  
15098 小程序增加事件ON_CLICK_INDEX_LOCK  
15097 增加事件ON_CLICK_INDEX_LOCK  
15096 小程序ChartLock代码重构  
15094 ChartLock代码重构  
15092 小程序k线图和分时图初始化使用SetSubFrameAttribute设置属性  
15090 ChartLock多行显示增加上下左右间距设置  
15088 ChartLock支持多行输出  
15087 分时图初始化使用SetSubFrameAttribute设置窗口属性  
15086 K线图初始化窗口设置统一使用SetSubFrameAttribute  
15085 JSDivFrameToolbar增加帮助按钮  
15083 分时图增加指标帮助  
15082 增加指标帮助  
15081 指标锁区域修改顶部位置， 标题不锁  
## 1.1.15078（2025-08-12）
更新预览图片
## 1.1.15077（2025-08-12）
内置组件增加横竖屏切换
## 1.1.15076（2025-08-11）
15075 小程序期货增加”铝合金“品种  
15074 期货增加”铝合金“品种  
15072 ChartLock竖屏背景色支持渐变  
15071 ExportStorageData()增加EnableCtrlMove属性保存  
15069 JSDivFrameToolbar增加更新按钮函数  
15068 ChartDrawPictureHorizontalLine导出时增加LabelConfig，InsideLabelConfig属性保存  
15067 .UMyChart_Toolbar_Tooltip_Div 默认隐藏  
## 1.1.15058（2025-08-05）
15056 增加函数ChartDrawStorage::Reload()  
15054 修正CMD_CHANGE_YRIGHT_TEXT_FORMAT切换类型2时，错误  
## 1.1.15035（2025-07-24）
5033 小程序分时图增肌函数ChangeIndexWindowCount  
15032 小程序K线增加ChangeIndexWindowCount  
15030 优化ChangeIndexWindowCount函数  
15028 T型报价增加现货价格匹配行权价格标记  
## 1.1.15002（2025-07-04）
15001 AverageWidthFrame::DrawHorizontal()修正xLine变量没有定义
## 1.1.15000（2025-07-04）
14999 ChartLock通过类工厂创建  
14996 分时图支持锁指标回调  
14994 报价列表ReserveString列支持彩色文字输出  
## 1.1.14993（2025-07-02）
14992 uniapp程序使用uni.createCanvasContext()创建画布
## 1.1.14991（2025-07-01）
14989 小程序去掉不用的图形类导入  
14988 报价列表ReserveString增加到20个  
14987 报价列表表头支持独立设置对齐方式TitleAlign  
14985 报价列表ReserveDateTime支持日期相同时，只显示第1个  
14984 IFrameSplitOperator.FormatDateTimeStringV2()增加"YYYY-MM-DD HH:MM"，"MM-DD HH:MM"格式  
14983 增加函数IFrameSplitOperator.IsGTEZero() >=0  
## 1.1.14982（2025-06-30）
14980 JSChartContainer::UpdatePointByCursorIndex() 修正鼠标在框架外部还会显示  
14979 报价列表数值类型增加到20个  
14977 JSReportChartContainer::RecvStockData()修正数据为空的不刷新  
14976 报价列表增加全量数据模式  
14973 ChartDrawTVLongPosition修正鼠标在图形上状态不正确  
## 1.1.14972（2025-06-30）
修正vue3在小程序下报"markRaw is not defined"错误
## 1.1.14971（2025-06-27）
14969 画图工具ChartDrawTVLongPosition代码优化  
14968 画图工具增加TVLongPosition, TVShortPosition  
14964 k线键盘左右移动，增加长按时间  
14963 DeleteIndexPaint()增加清空指标标题栏中的动态标题数据  
14961 T型列表修改单元格背景闪烁id  
14960 报价列表设置排序支持列ID，列标题，列类型  
## 1.1.14927（2025-06-06）
14925 JSCHART_OPERATOR_ID.OP_GOTO增加设置标题数据索引  
14923 报价列表修正LocalDataSort()报错  
14920 报价列表增加筛选功能  
14918 报价列表码表没有下载完下载在板块数据  
14917 报价列表RecvMemberListData()增加排序。  
14916 JSFloatTooltip支持动态修正标题span样式  
14914 报价列表增加码表和板块列表请求状态  
14913 DynamicChartTitlePainting::FormatValue()使用IFrameSplitOperator.FormatValueStringV2格式化字符串  
14911 ChartBaseLineBar主图指标支持标题输出  
14908 报价列表ReserveString支持tooltip设置  
14907 JSTooltipKLineChart增加字体大小设置  
14904 报价列表修正当股票列表为空时，实时数据请求不启动  
14902 报价列表单行选中代码逻辑调整  
14901 报价列表ChangeSymbol支持设置列  
## 1.1.14900（2025-06-03）
14899 报价列表ON_REPORT_LOCAL_SORT修正没有处理PreventDefault变量  
14897 报价列表事件ON_REPORT_LOCAL_SORT 优化  
14892 报价列表修正Date字段排序无效  
14890 报价列表RESERVE_STRING1_ID支持本地排序  
14889 报价列表支持动态更新板块成分  
14886 报价列表增加RESERVE_DATETIME1_ID本地排序功能  
## 1.1.14871（2025-05-29）
升级测试用了
## 1.1.14870（2025-05-29）
14868 小程序画图工具判断点是否在点上和是否在线上使用的自己的算法  
14867 增加函数Path2DHelper.PtInLine，Path2DHelper.PtInPoint，Path2DHelper.PtInArc  
14866 OverlayKLineFrame::DrawHorizontal()修正文字颜色没有设置  
14865 X轴刻度多行文字支持左对齐  
## 1.1.14864（2025-05-28）
14863 X轴底部文字支持多行输出  
14861 VERTLINE增加API配置字段  
14859 VERTLINE支持API对接  
14858 JSTooltipMinuteChart图形文字字体独立设置  
14857 弹出分时图增加图形文字字体设置  
## 1.1.14827（2025-05-26）
uniapp h5增加导出JSCHART_MENU_ID
## 1.1.14825（2025-05-25）
14823 封装addEventListener事件注册和删除事件  
14822 内置菜单增加销毁函数  
14819 修正JSDialogModifyDraw::Destroy()异常  
## 1.1.14768（2025-05-13）
14767 StockChip::DrawToolbarTooltip()修正text变量没有定义  
14765 修正JSReportChartContainer::UpdateStockData()空数据不更新  
## 1.1.14748（2025-05-06）
14747 小程序十字光标增加Status属性
14743 DynamicChartTitlePainting增加自定义位置属性
## 1.1.14742（2025-05-03）
14740 FrameSplitY优化集合竞价横屏代码  
14739 FrameSplitY优化集合竞价代码  
14736 增加更新交易状态函数  
14735 增加交易状态  
14733 DynamicChartTitlePainting集合竞价输出位置调整  
14732 分时图指标框支持集合竞价  
## 1.1.14731（2025-04-30）
14729 小程序十字光标右侧文字数据代码优化  
14727 十字光标右侧多行文本输出位置调整  
14723 k线类型0，2 支持自定义柱子颜色  
14721 十字光标右侧叠加指标文本输出代码优化  
14719 十字光标右侧文字输出代码优化  
14717 TryClickChartCell()数据返回增加图形信息  
14715 增加事件 “ON_CLICK_CHART_CELL”  
14714 点击模式下， 增加是否点击按钮变量  
## 1.1.14713（2025-04-23）
14712 指标标题换行增加考虑指标名称按钮高度  
14710 K线指标标题修正点击模式没有更新  
14708 小程序增加十字光标X文字点击。  
      小程序增加K线标题栏”IsShowDateTime“属性设置  
14707 K线标题栏增加“IsShowDateTime”属性设置  
## 1.1.14696（2025-04-15）
14695 修正FastSlideEvent()报错  
14694 优化手持快速移动代码  
14693 竖屏k线图和分时图增加快速滑动事件  
## 1.1.14691（2025-04-14）
14690 报价列表事件ON_DRAW_CUSTOM_TEXT都统一改为ON_REPORT_FORMAT_DRAW_INFO  
14689 报价列表 FormatDrawInfo函数统一调用 FormatDrawInfoEvent  
## 1.1.14688（2025-04-14）
14687 报价列表选中样式支持底部直线模式  
14686 分时图盘口分析增加颜色配置  
14685 分时图增加盘口分析图形  
14684 报价列表ReserveNumber，ReserveString支持ON_REPORT_FORMAT_DRAW_INFO事件  
## 1.1.14683（2025-04-11）
14682 ChartIndexTitle代码重构  
14680 小程序修正函数名拼错了, ChartDestory=>ChartDestroy  
14678 小程序AverageWidthFrame::DrawInsideHorizontal()支持YOffset  
14677 小程序十字光标左侧和底部文字输出代码整理  
14676 修正十字光标左侧文字输出错误  
14674 IChartPainting::ClipClient()顶部增加一个像素  
14673 DrawInsideHorizontal()支持YOffset  
14672 DrawInsideClientHorizontal()支持YOffset  
14671 K线其他K线类型增加剩余时间显示  
## 1.1.14671（2025-04-10）
修正HQChartControl销毁时报错
## 1.1.14670（2025-04-10）
14669 修正AverageWidthFrame::DrawTitleButton()计算ToolbarCacheSize变量数据错误
## 1.1.14660（2025-04-08）
14659 筹码图增加关闭按钮  
14657 小程序筹码图增加远期和近期分布  
14656 小程序修改函数拼写错误 SetSizeChage=>SetSizeChange  
14655 T型报价增加键盘回调事件  
14654 报价列表增加键盘回调事件  
14652 JSChartContainer::OnMouseMove()修正显示提示信息没有修改鼠标状态  
14649 TryMouseMove_CustomChartDrag()增加优先等级  
14646 ChartDrawSVG支持点击  
14644 增加指标图形缓存数据接口  
14642 修正ChartDrawSVG::DrawDetailText()没有设置字体信息  
14638 ChartKLineTable修正单元格左右显示区域保存错误  
14637 ChartDrawSVG增加详细信息重叠不显示选项  
14634 ChartKLineTable增加tooltip  
14629 ChartKLineTable代码重构  
14627 修正IsSHSZETFOption()错误  
14625 GetVolUnit()增加沪深ETF期权  
## 1.1.14624（2025-04-02）
14623 小程序筹码图修正黑色风格下文字不显示  
14620 报价列表增加SplashTitle提示信息设置  
14619 散点图重构2.0  
## 1.1.14606（2025-03-31）
14603 分时图增加最大显示天数设置  
