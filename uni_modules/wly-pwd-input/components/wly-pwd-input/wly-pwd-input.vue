<template>
	<view class="u-char-box">
		<view class="u-char-flex">
			<input :adjustPosition="adjustPosition" :cursorSpacing="80"  :disabled="disabledKeyboard" :value="valueModel" type="number" :focus="focus" :maxlength="maxlength" class="u-input" @input="getVal" @keyboardheightchange="keyboardheightchange"/>
...
<script>
	 ...
	 * @property {Number} maxlength 输入字符个数（默认4）
	 ...
	 * @example <wly-pwd-input mode="bottomLine"></wly-pwd-input>
	 */
	export default {
		name: "wly-pwd-input",
		props: {
