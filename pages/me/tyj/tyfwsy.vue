<template>
	<view class="content">
		<narBar :title="getLg('体验服务收益')" @back="toBack()"></narBar>
		...
		<view class="">
			...
			background-size: 100% 100%;">
				<scroll-view scroll-y="true" class="box" @scrolltolower="reachBottom"
					...
					<view class="" style="">
						<view class="flex-between-center pd20" style="border-bottom: 1rpx solid #eee;line-height: 1.8rem;"
							v-for="(item,index) in list" :key="index">
							<view class="">
								<view class="fw700 textMax" :style="{width:windowWidth +'px'}">
									{{item.tradeTitle}}
								</view>
	...
	export default {
		...
		data() {
			return {
				...
				windowWidth: uni.getSystemInfoSync().windowWidth - 150,
				isActive: 0,
				page: 1,
				size: 10,
				total: '',
