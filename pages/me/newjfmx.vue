<template>
	...
	<view class="content">
		...
		<view class="flex-column-center  mx40" style="margin-top: -90rpx; "> 
				<view class="mt20" style="width: 100%; border-radius: 16rpx;
				 background-image:  url('/static/null/jfmx1.png'); 
									  background-repeat: no-repeat; 
									  background-size:cover;
									background-size: 100% 100%;
				...
				">
				<view class="fw400 fz28" style="line-height: 45rpx;color: #fff;margin-top:60rpx;margin-left: 50rpx;">
					<view>当前积分</view>
					 <view>999999</view>
				</view>
			 	...
			 	<view class="mt20" style="width: 100%;background: linear-gradient(to bottom, #fee9eb,  #ffffff, #ffffff);border-radius: 16rpx;">
					...
					<view class="flex-start-center fz30 fw500" style="padding: 30rpx 40rpx 30rpx 40rpx;">
						<view>收入</view>
						<view class="" style="margin-left:150rpx">支出</view>
					</view>
					<view  v-for="(item,index) in list"  class="flex-between-center  fz24 fw400 " style="padding: 30rpx 40rpx 30rpx 40rpx;border-bottom: 1rpx solid #c5c5c5;">
					 
							 
					<view class="" style="color:#000000;line-height: 40rpx;">
					  <view class="fw600">{{item.name}}</view>
					<view class="fz20">2025-05-05 8:50</view>
					</view>
				 
					<!-- #ea564d -->
					<!-- #32bf68 -->
					<view class=" fw600 " style="color: #ea564d;">+99</view>
