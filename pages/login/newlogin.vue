			...
			<view class="flex-column-center-center " style="margin-top: 90rpx;">
				...
				style="width: 400rpx;" mode="widthFix">
				 ...
				 <view class="flex-center-center mt40" style="">
				 	<view @click="toeamilLogin()" class="flex-center-center fz26" style="background-color:#f0f0f0 ;border-radius:50rpx;">
						<view style="  background-color:#bf1609 ;color:#fff;padding: 15rpx 60rpx;border-radius: 50rpx; ">手机登录</view>
				 		<view style="padding: 15rpx 60rpx;color:#000;" class="py30">邮箱登录</view>
				 		
				 	</view>
				 </view>
				<view class="flex-column-start-center" style="width:100vw;margin-top: 40rpx; font-family: 'OPPOSans';" >
					<view class="" style="width:calc(100vw - 76px)">
						<view class="flex-row-around-center"><image src="/static/null/user.png"	style="width: 30rpx;" mode="widthFix" />
				              <text class="ml20 fw600 fz26">用户名</text>
						</view>
						<view>
							
							<input class="vinput" style="width:90%;padding-left:0rpx;font-size: 26rpx;color: #000;" type="text" placeholder-style="color:#a1a1a1" v-model="loginInfo.telPhone"
									 maxlength="15" placeholder="请输入用户名/手机号" />
						</view>
						
						<view class="mt40 flex-row-around-center"><image src="/static/null/lock.png"	style="width: 28rpx;" mode="widthFix" />
						      <text class="ml20 fw600 fz26">密码</text>
						</view>
						<view>
					...
					<view class="color-fff fz26" @click="versionLogin()" style="background-color: #dd322a;border-radius: 50rpx;padding: 20rpx 180rpx;margin-top: 140rpx;">
						登录
					</view> 
					
					<view class=" fz26 " @click="toReg()" style="color:#000;background-color: #f7f1f1;border-radius: 50rpx;padding: 20rpx 180rpx;margin-top: 40rpx;">
						注册
					</view> 
...
<script>
	...
	export default {
		...
		onLoad(option) {
					...
					this.loginInfo.telPhone=uni.getStorageSync('phone');
						...
						this.$request.get({
							...
							success: rsp => {
								...
								if (rsp.code == 200) {
								 ...
								 uni.setStorageSync('phone', this.loginInfo.telPhone )
