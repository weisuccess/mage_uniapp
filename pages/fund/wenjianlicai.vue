<template>
	...
	<view class="content">
	     <narBarAndTop :background="'#fb4034'"  :title="'稳健理财'"    @back="toBack()">
		...
		<view class="flex-column-center  mx40" style="margin-top: -70rpx; "> 
			 	...
			 	<view v-for="(item,index) in list"  class="mt20 flex-start-center" style="width: 100%;background-color: #ffffff; border-radius: 10rpx 0 0 10rpx;">
					...
					<view style="width: 100rpx;color:#ffffff;height:100rpx;background-color: #ff557f; border-radius: 10rpx 0 0 10rpx;" class="fz24 text-align-c py60">
					...
					">
						<view class="text-align-c fz22 " style="color: #ec5d53;background-color: #fee8e7; border-radius: 38rpx;border: 1px solid #fbb8b6;;padding: 3rpx 7rpx;">每日付息到期还本</view>
						<view class="mt20 fz26 flex-column-center" style="padding: 5rpx 20rpx; width:200rpx; background-color: #f8f8f8;">
							<view class="fz22">项目规模</view>
							 <view class="fw600 fz22">6.2百万USDT</view>
						</view>
