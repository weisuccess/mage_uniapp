<template>
	...
	<view class="content">
	     <narBarAndTop :background="'#fb4034'"  :title="'黄金'"    @back="toBack()">
		...
		<view class="flex-column-center  mx40" style="margin-top: -70rpx; "> 
			 	...
			 	<view v-for="(item,index) in list"  class="mt20 flex-start-center" style="width: 100%;background-color: #ffffff; border-radius: 10rpx 0 0 10rpx;">
					...
					<view style="width: 100rpx;color:#ffffff;height:100rpx;background-color: #e89e34; border-radius: 10rpx 0 0 10rpx;" class="fz24 text-align-c py60">
					...
					">
						<view class="text-align-c fz22 " style="color: #e9be4c;background-color: #faf1d0; border-radius: 38rpx;border: 1px solid #e9be4c;;padding: 3rpx 7rpx;">每日付息到期还本</view>
