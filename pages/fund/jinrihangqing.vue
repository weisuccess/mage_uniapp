<template>
	...
	<view class="content">
	     <narBarAndTop :background="'#fb4034'"  :title="'上证指数'"    @back="toBack()">
		...
		<view class="flex-column-center  mx40" style="margin-top: -70rpx; "> 
			 	...
			 	<view class="mt20" style="width: 100%;background-color: #ffffff; border-radius: 14rpx;">
					<view  class="flex-between-center  px30  mt20">
						<view class=" text-align-c fz32 fw400" style="">上证指数</view>
						<view class=" text-align-c fz24" style="">已收盘2025-08-19</view>						 
					</view>
					 
				 
					<view class="text-align-c  fw600 mt20 color-zhi" style="font-size:55rpx ;">
						3725555.85						
					</view>
					<view class="text-align-c  fw400 mt20" style="color:#096000;font-size:28rpx ;">
					   <text class="mr20">-0.2537</text>	<text class="ml20">-0.2357</text>					
					</view>
					
					<view class="text-align-c  fw500 mt20" style="color:#000000;font-size:30rpx ;">
					   <text class="mr20">成交量： 6.58亿手</text>	<text class="ml20">振幅:0.7565%</text>					
					</view>
					<view class="mt50 ml30"> 走势图</view>
						<image src="/static/null/hqtest.png"  style="width: 100%" mode="widthFix" />
