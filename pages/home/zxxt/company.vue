<template>
	...
	<view class="content">
	     <narBarAndTop :background="'#fb4034'"  :title="'公司简介'"    @back="toBack()">
		...
		<view class="flex-column-center  mx40" style="margin-top: -90rpx; "> 
			 	...
			 	<view class="mt20" style="width: 100%;background: linear-gradient(to bottom, #fee9eb,  #ffffff, #ffffff); border-radius: 16rpx;">
					...
					<view class="" style="margin: 40rpx 30rpx;">
								 
					 <image src="/static/null/company1.png"  style="width: 100%;" mode="widthFix" />
					  <image src="/static/null/company2.png"  style="margin-top: 30rpx;width: 100%;" mode="widthFix" />
				 </view>
