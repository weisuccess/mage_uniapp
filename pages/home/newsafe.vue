<template>
	...
	<view class="content">
	     <narBarAndTop :background="'#fb4034'"  :title="'安全保障'"    @back="toBack()">
		...
		<view class="flex-column-center  mx40" style="margin-top: -90rpx; "> 
			 	...
			 	<view v-for="(item,index) in piclist" class="mt20 flex-column-center" style="width: 100%;background-color: #ffffff; border-radius: 16rpx;">
					 <image @click="preview(item)" :src=item  class="my20" style="width: 600rpx;" mode="widthFix" />
					 
				</view>
				<!-- <view class="mt20 flex-column-center" style="width: 100%;background-color: #ffffff; border-radius: 16rpx;">
					 <image @click="preview('/static/safe/safe2.jpg')" src="/static/safe/safe2.jpg"  class="my20" style="width: 600rpx;" mode="widthFix" />
					 
				</view>
				<view class="mt20 flex-column-center" style="width: 100%;background-color: #ffffff; border-radius: 16rpx;">
					 <image src="/static/safe/safe3.jpg"  class="my20" style="width: 600rpx;" mode="widthFix" />
	...
	export default {
		...
		data() {
			return {
				...
				noClick: true,
				piclist: [
					 '/static/null/safe1.jpg','/static/null/safe2.jpg','/static/null/safe3.jpg','/static/null/safe4.jpg'
				],
