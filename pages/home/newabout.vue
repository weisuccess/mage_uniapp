<template>
	...
	<view class="content">
	     <narBarAndTop :background="'#fb4034'"  :title="'关于我们'"    @back="toBack()">
		...
		<view class="flex-column-center  mx40" style="margin-top: -70rpx; letter-spacing: 2px;"> 
			 	...
			 	<view class="mt20 " style="padding:20rpx 20rpx;width:calc(100% - 10px);background-color: #fff;border-radius: 8rpx;">
					 <view   class="flex-center-center  fz30 fw400 mt40 ">
						<image src="/static/icon.png"  style="width: 80rpx;" mode="widthFix" /> 
					 
						
					 </view>
					 <view class="flex-between-center fz24 px20" style="margin-top: 100rpx;border-bottom: 1px solid #bfbfbf; padding-bottom: 20rpx;">
					 	<view>当前版本</view>
					 	<view class="flex-center-center"> v{{this.version}} <text decode>{{kong}}</text> <uni-icons type="right" size="15"></uni-icons></view>
					 </view>
